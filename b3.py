...
# Card info lookup (simplified example, you may want to use a proper BIN database)
CARD_INFO = {
    "51": {"brand": "Mastercard", "type": "ENHANCED", "card_type": "DEBIT", "issuer": "HUNTINGTON NATIONAL BANK", "country": "UNITED STATES 🇺🇸"},
    "52": {"brand": "Mastercard", "type": "ENHANCED", "card_type": "DEBIT", "issuer": "HUNTINGTON NATIONAL BANK", "country": "UNITED STATES 🇺🇸"},
...
async def check_cc(cx: str, user_id: int, tier: str) -> dict:
    ...
    try:
        ...
        try:
            ...
            bin_prefix = cc[:2]
            card_details = CARD_INFO.get(bin_prefix, {
                "brand": "Unknown",
                "type": "Unknown",
                "card_type": "Unknown",
                "issuer": "Unknown",
