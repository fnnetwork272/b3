...
# Helper to run synchronous functions asynchronously
loop = asyncio.get_event_loop()
async def run_sync_func(func, *args):
    return await loop.run_in_executor(None, func, *args)

# Determine if a card is charged based on API response
def is_charged(message):
    # Placeholder: adjust based on actual API success response
    return "success" in message.lower()  # Example; replace with actual success indicator
...
# Handle /mchk command for multiple card checks
