...
def handle_file(update: Update, context):
    ...
    msg = context.bot.send_message(user_id, "✅ 𝐅𝐢𝐥𝐞 𝐑𝐞𝐜𝐞𝐢𝐯𝐞𝐝! 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠 𝐂𝐡𝐞𝐜𝐤𝐢𝐧𝐠...\n"
...
def main():
    ...
    dp.add_handler(MessageHandler(filters.Document.ALL, handle_file))  # Updated filter syntax
