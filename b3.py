...
async def check_cc(cc_details):
    ...
    bin_number = cc[:6]
    issuer, country, card_type = await get_bin_details(bin_number)
...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for i, cc_details in enumerate(cc_list):
        ...
        # Refined progress format to match the screenshot description
    ...
    keyboard = [
        ...
        [InlineKeyboardButton(f"✖️ Declined: {declined}", callback_data='view_declined')],
