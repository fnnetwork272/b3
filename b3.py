...
# Bot token
TOKEN = os.getenv('TELEGRAM_BOT_TOKEN', '8009942983:AAFDljoftiyUk4D2bzzh1GWEroNWqMQNlLs')
...
async def single_check(user_id, cc_details, update, context):
    ...
    logger.info(f"Completed single_check for user {user_id}, card: {cc_details}, status: {result['status']}")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "📁 𝐒𝐞𝐧𝐝 𝐂𝐨𝐦𝐛𝐨 𝐅𝐢𝐥𝐞 𝐎𝐫 𝐄𝐥𝐬𝐞 𝐔𝐬𝐞 𝐁𝐮𝐭𝐭𝐨𝐧 𝐁𝐞�.l𝐨𝐰:",
