...
def b3req(cc, mm, yy):
    ...
    logger.debug(f"Sending Braintree request for cc: {cc}, mm: {mm}, yy: {yy}")
...
def brainmarkreq(b3tkn, mm, yy, bin, Type, lastfour, lasttwo):
    ...
    logger.debug(f"Sending Brandmark request with nonce: {b3tkn}")
...
async def process_file(file_path, update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    for line in lines:
        ...
        logger.debug(f"Processing card: {card_number}|{expiry_month}|{expiry_year}")
...
<b>[✪] 𝐃𝐞𝐜𝐥𝐢𝐧𝐞𝗱:</b> {stats['declined']}
<b>[✪] 𝐂𝐡𝐞𝐜𝐤𝐞𝗱:</b> {stats['checked']}/{stats['total']}
<b>[✪] 𝐓𝐨𝐭𝐚𝐥:</b> {stats['total']}
<b>[✪] 𝐃𝐮𝐫𝐚𝐭𝐢𝗼𝗻:</b> {duration:.2f} seconds
<b>[✪] 𝐀𝐯𝐠 𝐒𝐩𝐞𝐞𝗱:</b> {avg_speed:.2f} cards/sec
<b>[✪] 𝐒𝐮𝗰𝗰𝐞𝘀𝘀 𝐑𝐚𝐭𝐞:</b> {success_rate:.2f}%
━━━━━━━━━━━━━━━━━━━━━━
...
async def chk(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.debug(f"Checking single card: {card_number}|{expiry_month}|{expiry_year}")
...
"""
    ...
    country = bin_data.get('countryOfIssuance', 'Unknown') if bin_data else 'Unknown'
...
<b>[⌬] 𝐅𝐍 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 𝐋𝐈𝐕𝐄 𝐏𝐑𝐎𝐆𝐑𝐄𝐒𝐒 😈⚡</b>
━━━━━━━━━━━━━━━━━━━━━━
<b>[✪] 𝐀𝐩𝐩𝐫𝐨𝐯𝐞𝗱:</b> {stats['approved']}
<b>[✪] 𝐃𝐞𝗰𝗹𝗶𝗻𝗲𝗱:</b> {stats['declined']}
<b>[✪] 𝐂𝐡𝐞𝗰𝗸𝗲𝗱:</b> {stats['checked']}/{stats['total']}
<b>[✪] 𝐓𝐨𝐭𝐚𝐥:</b> {stats['total']}
<b>[✪] 𝐃𝐮𝗿𝗮𝘁𝗶𝗼𝗻:</b> {duration:.2f} seconds
<b>[✪] 𝐀𝘃𝗴 𝐒𝐩𝐞𝗲𝗱:</b> {avg_speed:.2f} cards/sec
<b>[✪] 𝐒𝘂𝗰𝗰𝗲𝘀𝘀 𝐑𝐚𝘁𝐞:</b> {success_rate:.2f}%
━━━━━━━━━━━━━━━━━━━━━━
<b>[み] 𝐃𝐞𝘃: @FNxELECTRA ⚡😈</b>
━━━━━━━━━━━━━━━━━━━━━━
"""
            await context.bot.send_message(chat_id=update.effective_chat.id, text=progress_message, parse_mode='HTML')
...
[⌬] 𝐅𝐍 𝐂𝐇𝐄𝐂𝐊𝐄𝐑 𝐒𝐓𝐀𝐓𝐈𝐂𝐒 😈⚡
━━━━━━━━━━━━━━━━━━━━━━
[✪] 𝐂𝐡𝐚𝐫𝐠𝐞𝗱: {stats['approved']}
[❌] 𝐃𝐞𝗰𝗹𝗶𝗻𝗲𝗱: {stats['declined']}
[✪] 𝐓𝐨𝐭𝐚𝐥: {stats['total']} 
[✪] 𝐃𝐮𝗿𝗮𝘁𝗶𝗼𝗻: {duration:.2f} seconds
[✪] 𝐀𝘃𝗴 𝐒𝐩𝐞𝗲𝗱: {avg_speed:.2f} cards/sec
[✪] 𝐒𝘂𝗰𝗰𝗲𝘀𝘀 𝐑𝐚𝘁𝐞: {success_rate:.2f}%
━━━━━━━━━━━━━━━━━━━━━━
[み] 𝐃𝐞𝘃: @FNxELECTRA ⚡😈
━━━━━━━━━━━━━━━━━━━━━━
"""
