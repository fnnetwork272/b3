...
def check_cc(cc, mes, ano, cvv, proxy=None):
    ...
    try:
        ...
        add_nonce = re.search(r'name="woocommerce-add-payment-method-n 압에서 nonce" value="(.*?)"', r.text).group(1)
...
async def start(update: Update, context):
    keyboard = [
        ...
        [InlineKeyboardButton("Cancel("Cancel Check", callback_data='cancel_check')]
    ]
