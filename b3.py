...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"""✅ 𝐅𝐢𝐥𝐞 𝐑𝐞𝐜𝐞𝐢𝐯𝐞𝐝! 𝐒𝐭𝐚𝐫𝐭𝐢𝐧𝐠 C𝐡𝐞𝐜𝐤𝐢𝐧𝐠...
...
[✪] 𝐒𝐮𝗰𝗰𝗲𝘀𝘀 𝐑𝐚𝐭𝐞: {success_rate:.2f}%
━━━━━━━━━━━━━━━━━━━━━━
[み] 𝐃𝐞𝐯: <a href='tg://user?id=7593550190'>𓆰𝅃꯭᳚⚡!! ⏤͟𝐅ɴ x 𝐄ʟᴇᴄᴛʀᴀ𓆪𓆪⏤͟➤⃟🔥✘</a>"""
    )
...
async def genkey(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    response = (
        f"🎁 𝐆𝐢𝐟𝐭 𝐊𝐞𝐲𝐬 𝐆𝐞𝐧𝐞𝐫𝐚𝐭𝐞𝐝 𝐒𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲! 🎉\n\n"
        f"🔢 𝐐𝐮𝐚𝐧𝐭𝐢𝐭𝐲: {quantity}\n"
        f"📋 𝐃𝐞𝐚𝐭𝐢𝐥𝐬:\n" +
