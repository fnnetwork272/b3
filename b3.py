...
━━━━━━━━━━━━━━━━━━━━━━
<b>[✪] �{C𝐡𝐚𝐫𝐠𝐞𝐝:</b> {task_stats['approved']}
...
"""
        ...
        if i + batch_size < len(lines):
            logger.info(f"Chat {chat_id}: Waiting 45 seconds to avoid rate limiting...")
...
async def button(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'upload_combo':
        ...
        # Fetch stats from context.chat_data or assume default if no task is active
...
[✪] 𝐓�{o𝐭𝐚𝐥: {task_stats['total']}
[✪] 𝐃𝐮𝐫�{a𝘁𝗶𝘂𝗻: {duration:.2f} seconds
