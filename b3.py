...
<b>[✪] 𝐓𝐨𝐭𝐚𝐥:</b> {stats['total']}
<b>[✪] 𝐃𝐮𝐫𝐚𝘁𝗶𝗼𝗻:</b> {duration:.2f} seconds
<b>[✪] 𝐀𝐯𝐠 𝐒𝐩𝐞𝐞�{d:</b> {avg_speed:.2f} cards/sec
<b>[✪] 𝐒𝐮𝗰𝗰𝗲𝘀𝘀 𝐑𝐚𝘁𝗲:</b> {success_rate:.2f}%
━━━━━━━━━━━━━━━━━━━━━━
<b>[み] 𝐃𝐞𝐯: <a href="{dev_link}">{dev_name}</a> ⚡😈</b>
━━━━━━━━━━━━━━━━━━━━━━
...
𝐌𝐞𝐬𝐬𝐚𝐠𝐞: 𝐂𝗼𝗻𝗴𝗿𝗮𝘁𝘇! 𝐘𝗼𝘂𝗿 𝐏𝗿𝗼𝘃𝗶𝗱𝗲𝗱 𝐆𝗶𝗳𝘁𝗰𝗼𝗱𝗲 𝐒𝘂𝗰𝗰𝗲𝘀𝘀𝗳𝘂𝗹𝗹𝘆 𝐑𝐞𝗱𝐞𝐞𝗺𝐞𝗱 𝘁𝗼 𝐘𝗼𝘂�_r 𝐀𝗰𝗰𝗼𝘂𝗻𝘁, 𝐀𝗻𝗱 𝐘𝗼𝘂 𝐆𝗼𝘁 𝗮 "{key_data['tier']} 𝐅𝗼𝗿 {key_data['duration_days']} 𝐃𝐚𝐲𝘀".
"""
    await update.message.reply_text(response, parse_mode='HTML')
